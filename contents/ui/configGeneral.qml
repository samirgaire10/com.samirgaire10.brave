...
Kirigami.FormLayout {
    ...
    QQC2.Label {
		font.pixelSize: 12
		text:i18n("When checked pressing Enter will send the query to google.");
	}
	QQC2.Label {
		font.pixelSize: 8
		font.italic: true
	...
	QQC2.CheckBox {
        ...
        text: i18n("Allow google system clipboard access")
    }
    QQC2.Label {
		font.pixelSize: 8
		font.italic: true
		text:i18n("This is enabled by default to allow for quick code/recipe/etc but can be disabled if you are worried about google search  examining your system clipboard");
	}
